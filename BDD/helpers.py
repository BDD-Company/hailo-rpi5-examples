...
# Flight-mode (pre-flight detection / in-flight pursuit) machinery now lives in flight_mode.py
# (FlightMode, FlightModeController, Tile, tile_layout, remap_tile_bbox). It imports XY/Rect/
# DEFAULT_CAMERA_ID from here, so keep that one-way dependency intact (do not import it back).
