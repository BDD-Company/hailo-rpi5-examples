...
from helpers import Detections, Detection, XY, Rect
...
def process_output(output, dest, display=False):
    ...
    move_command : XY | None = output.get('move_command', None)
    ...
    if move_command is not None:
        ...
        move_command_end = frame_center + move_command * 3
...
def debug_output_thread(output_queue : Queue, file_name, target_fps = 30, display = False):
